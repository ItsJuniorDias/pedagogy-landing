...
export const LEVELS = [
  { id: 'sprout', label: 'Little Sprout', sub: 'Ages 2–3 · First sounds & songs', emoji: '🌱' },
  { id: 'explorer', label: 'Sound Explorer', sub: 'Ages 4–5 · Letters & phonics', emoji: '🔤' },
  { id: 'reader', label: 'Early Reader', sub: 'Ages 6–7 · First words & stories', emoji: '📖' },
  { id: 'star', label: 'Story Star', sub: 'Ages 8–10 · Fluent reading', emoji: '⭐' },
]
...
export const SEED_READERS = [
  {
    ...
    age: 5,
    level: 'explorer',
    stats: sampleStats({ streak: 7, storiesRead: 23, minutesThisWeek: 112, lettersLearned: 24 }),
  },
  {
    id: 'rdr_leo',
    name: 'Leo',
    ...
    stats: sampleStats({
      ...
      minutesThisWeek: 78,
      lettersLearned: 26,
      week: [8, 14, 16, 6, 20, 9, 5],
      path: [
        { name: 'Letters', emoji: '🔤', done: 6, total: 6, color: 'sunny' },
        { name: 'Dinos', emoji: '🦕', done: 5, total: 6, color: 'mint' },
        { name: 'Ocean', emoji: '🐠', done: 3, total: 6, color: 'sky' },
        { name: 'Science', emoji: '🔬', done: 1, total: 6, color: 'grape' },
      ],
    }),
  },
]
